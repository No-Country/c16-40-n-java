...
const NewProjectPageContainer = () => {
  return (
    <section className="flex flex-col items-center h-full">
      <div className="m-auto w-[95%] lg:w-5/6 rounded-lg px-5 py-10 mt-20 lg:mt-24 mb-10 flex flex-col lg:flex-row justify-between">
        <div className="flex flex-col items-center justify-center gap-4 p-5 lg:w-1/2">
        ...
        <div className="flex flex-col bg-white rounded-lg p-5 lg:p-10 lg:w-1/2">
